<!-- Sidebar -->
<div id="sidebar" class="min-vh-100 d-flex flex-column flex-shrink-0 p-3 m-0">
    <a href="/dashboard" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-dark text-decoration-none">
